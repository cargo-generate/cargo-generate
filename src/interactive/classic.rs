// Internal callers within this module reference each other's deprecated
// functions; suppress the noise for the module itself.
#![allow(deprecated)]
...
#[deprecated(
    since = "0.24.0",
    note = "classic dialoguer/indicatif UI; opt into `ui-next` instead"
)]
