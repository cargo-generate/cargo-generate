...
- Fix link to examples and improve wording ([#1428](<REPO>/issues/1428))

### 🛠️ Maintenance

- Bump git2 from 0.20.0 to 0.20.1 ([#1430](<REPO>/issues/1430))

### 🤕 Fixes

- Fix array placeholders misbehave when not selecting any items ([#1441](<REPO>/issues/1441))
- Handle optional package.name field in workspace_member ([#1442](<REPO>/issues/1442)) ([#1443](<REPO>/issues/1443))
- Fix lints ([#1446](<REPO>/issues/1446))
- Update cargo-util-schemas to 0.7.3 and fix optional type for package name ([#1447](<REPO>/issues/1447))
