...
use-cases, or other aspects of this general problem space are welcome!
...
code does not collide with the existing code, in executing the unit tests.
...
For complex issues, and solutions, we did not create unit tests yet.
Otherwise, we have manual tests in order to check if everything is ok.

For example, to test if your code does not collide with the solution of the
...
Before you submit your pull request, check that you have completed all the
...
We expect everyone who participates in this project in any way to be friendly,
